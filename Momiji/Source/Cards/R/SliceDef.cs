...
{
    public sealed class SliceDef : SampleCharacterCardTemplate
    {
    ...
    [EntityLogic(typeof(SliceDef))]
    public sealed class Slice : SampleCharacterCard
    {
